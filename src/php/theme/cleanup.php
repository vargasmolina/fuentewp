 ...
 *
 * @package WordPress
 * @subpackage Nulificacion
 * @since Nulificacion 1.0.0
 */

if ( ! function_exists( 'Nulificacion_start_cleanup' ) ) :
function Nulificacion_start_cleanup() {

	// Launching operation cleanup.
	add_action( 'init', 'Nulificacion_cleanup_head' );

	// Remove WP version from RSS.
	add_filter( 'the_generator', 'Nulificacion_remove_rss_version' );

	// Remove pesky injected css for recent comments widget.
	add_filter( 'wp_head', 'Nulificacion_remove_wp_widget_recent_comments_style', 1 );

	// Clean up comment styles in the head.
	add_action( 'wp_head', 'Nulificacion_remove_recent_comments_style', 1 );

	// Clean up gallery output in wp.
	add_filter( 'Nulificacion_gallery_style', 'Nulificacion_gallery_style' );

}
add_action( 'after_setup_theme','Nulificacion_start_cleanup' );
endif;
/**
 * Clean up head.+
 * ----------------------------------------------------------------------------
...
if ( ! function_exists( 'Nulificacion_cleanup_head' ) ) :
function Nulificacion_cleanup_head() {
...
// Remove WP version from RSS.
if ( ! function_exists( 'Nulificacion_remove_rss_version' ) ) :
function Nulificacion_remove_rss_version() { return ''; }
endif;

// Remove injected CSS for recent comments widget.
if ( ! function_exists( 'Nulificacion_remove_wp_widget_recent_comments_style' ) ) :
function Nulificacion_remove_wp_widget_recent_comments_style() {
...
if ( ! function_exists( 'Nulificacion_remove_recent_comments_style' ) ) :
function Nulificacion_remove_recent_comments_style() {
...
if ( ! function_exists( 'Nulificacion_gallery_style' ) ) :
function Nulificacion_gallery_style( $css ) {
...
// if ( ! class_exists( 'Nulificacion_img_rebuilder' ) ) :
// 	class Nulificacion_img_rebuilder {
...
// 	$Nulificacion_img_rebuilder = new Nulificacion_img_rebuilder;
...
// add_action('woocommerce_before_main_content', 'Nulificacion_before_content', 10);
// remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10);
// add_action('woocommerce_after_main_content', 'Nulificacion_after_content', 10);
?>

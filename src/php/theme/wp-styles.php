...
function mi_theme_custom_styles($custom) {
	...
	$settings = get_theme_mod( 'font_setting_css');

	//Build CSS
	$custom 	= '';
	// print_r($settings);
	// foreach( $settings as $setting ) {
	// 	$custom .= $setting['link_html'] ."{". $setting['link_css'] . "}"."\n";
	// } 
	...
	wp_add_inline_style( 'mi_theme-style', $custom );	

}
add_action( 'wp_enqueue_scripts', 'mi_theme_custom_styles' );